...
import {Home,AddPost,EditPost,AllPosts,Login,Signup,Post,MyPosts} from "./pages/index.js"
...
const router = createBrowserRouter(
  createRoutesFromElements(
    <Route path='/' element={<App />}>
      ...
      <Route path='/my-posts' element={<AuthLayout authentication><MyPosts /></AuthLayout>} />
